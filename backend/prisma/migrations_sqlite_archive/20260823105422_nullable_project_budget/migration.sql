...
INSERT INTO "new_Project" ("budget", "client", "currency", "desc", "due", "health", "id", "integrationsJson", "isArchived", "name", "ownerId", "progress", "publicShareExpiresAt", "publicShareToken", "sourceTemplateId", "sourceTemplateVersion", "spent", "start", "workspaceId") SELECT "budget", "client", "currency", "desc", "due", "health", "id", "integrationsJson", "isArchived", "name", "ownerId", "progress", "publicShareExpiresAt", "publicShareToken", "sourceTemplateId", "sourceTemplateVersion", "spent", "start", "workspaceId" FROM "Project";
DROP TABLE "Project";
